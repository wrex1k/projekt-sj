...
<body>
  ...
  <div class="container">
    ...
    <div class="right-half">
      <div>
        <form class="reglog-wrapper" id="registrationForm" method="POST" action="includes/userManager.php">
          ...
          <input class="insert" id="re-password" type="password" name="re-password" placeholder="Confirm Password"
            required />
          <div class="terms">
            <input class="" type="checkbox" name="agree-terms" id="agree-terms" class="terms" required />
            <a href="terms.php" class="white">
